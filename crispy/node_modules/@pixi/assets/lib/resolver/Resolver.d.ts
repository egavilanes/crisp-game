import type { ArrayOr, AssetsBundle, AssetsManifest, AssetSrc, LoadParserName, ResolvedAsset, UnresolvedAsset } from '@pixi/assets/lib/types';
import type { PreferOrder, ResolveURLParser } from '@pixi/assets/lib/resolver/types';
