import type { FederatedEventTarget } from '@pixi/events/lib/FederatedEventTarget';
/**
 ...
 * @ignore
 */
export declare type EmitterListeners = Record<string, EmitterListener | EmitterListener[]>;
export {};
/**
